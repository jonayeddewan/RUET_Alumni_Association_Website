...
include 'db_connect.php'; 
 $topic = $conn1->query("SELECT *,u.name from forum_topics f inner join users u on u.id = f.user_id  where f.id = ".$_GET['id']);
...
<div class="container mt-3 pt-2">
    <div class="card mb-4">
  	...
  	$comments = $conn1->query("SELECT f.*,u.name,u.username FROM forum_comments f inner join users u on u.id = f.user_id where f.topic_id = $id order by f.id asc");
  	?>
    <div class="card mb-4">
    	<div class="card-body">
    		<div class="col-lg-12">
    			...
    			<div class="form-group comment">
                    <?php if($_SESSION1['login_id'] == $row['user_id']): ?>
