...
if(isset($_REQUEST['pwdrst']))
{
  ...
  if($pwd == $cpwd)
  {
    $reset_pwd = mysqli_query($connection,"update alumnus_bio set password='$pwd' where email='$email'");
    if($reset_pwd>0)
    {
      $msg = 'Your password updated successfully <a href="admin/index.php">Click here</a> to login';
    }
    else
    {
...
if($_GET['secret'])
{
  ...
  $check_details = mysqli_query($connection,"select email from alumnus_dio where email='$email'");
