...
if(isset($_REQUEST['pwdrst']))
{
  ...
  if($pwd == $cpwd)
  {
    $reset_pwd = mysqli_query($conn1,"update users set password='$pwd' where username='$email'");
    if($reset_pwd>0)
    {
...
if($_GET['secret'])
{
  ...
  $check_details = mysqli_query($conn1,"select email from alumnus_bio where email='$email'");
